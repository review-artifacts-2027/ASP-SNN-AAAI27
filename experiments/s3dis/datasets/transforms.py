...
def pointwolf_seg(slices: np.ndarray, pts_features: np.ndarray,
    ...
    for anchor in anchors:
        ...
        for m in range(M):
            delta_sl = slices_out[m, :, :3] - anchor
            dist_sl  = np.linalg.norm(delta_sl, axis=1)
